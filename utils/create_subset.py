...
def copy_images(source_folder, destination_folder, num_images=20):
    ...
    for root, dirs, files in os.walk(source_folder):
        for directory in dirs:
            ...
            image_files = [f for f in os.listdir(source_path) if f.endswith('.jpg') or f.endswith('.png')]
...
if __name__ == "__main__":
    ...
    copy_images(source_directory, destination_directory, num_images=num_images_per_folder)
